...
//             // 边界判断
//             if (prop.startsWith("on")) { // 对事件监听的判断
//                 el.addEventListener(prop.slice(2).toLocaleLowerCase(), value)
//             } else {
...
//         if (typeof newChildren === "string") { // 情况一： newChildren 是一个字符串
//             // 边界判断 edge case
